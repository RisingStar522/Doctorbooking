    ...
    module.exports = function maskScope(actionObj, maskset, opts) {
          ...
          function handleMatch(match, loopNdx, quantifierRecurse) {
            ...
            if (void 0 !== match.matches) {
              if (match.isGroup && quantifierRecurse !== match) {
                ...
                var alternateToken = match, malternateMatches = [], maltMatches, currentMatches = matches.slice(),
                  loopNdxCnt = loopNdx.length, altIndex = 0 < ndxInitializer.length ? ndxInitializer.shift() : -1;
      ...
      function determineNewCaretPosition(selectedCaret, tabbed) {
        ...
        selectedCaret.begin === selectedCaret.end) switch (opts.positionCaretOnClick) {
          ...
          default:
            var clickPosition = selectedCaret.begin, lvclickPosition = getLastValidPosition(clickPosition, !0),
          ...
          if (getBuffer().join("") !== inputValue) {
            ...
            getBuffer().join("") !== inputValue) {
              var buffer = getBuffer().join(""),
                ...
                frontPart = inputValue.substr(0, caretPos.begin), backPart = inputValue.substr(caretPos.begin),
                frontBufferPart = buffer.substr(0, caretPos.begin + offset),
                backBufferPart = buffer.substr(caretPos.begin + offset), selection = caretPos, entries = "",
                isEntry = !1;
