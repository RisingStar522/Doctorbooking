...
@Component({
  selector: 'app-home-slider-two',
  templateUrl: './home-slider-two.component.html',
  styleUrls: ['./home-slider-two.component.css']
})
export class HomeSliderTwoComponent implements OnInit {
